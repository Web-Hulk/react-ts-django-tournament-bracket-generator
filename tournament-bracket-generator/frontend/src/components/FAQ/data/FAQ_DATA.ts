...
export const FAQ_DATA: FAQ[] = [
  {
    header: "1. What are the general principles of the tournament?",
    body: "The tournament will take place on 13.10.2023 at the Auditorium – GOP, Katowice Office from 15:00 – 19:30.",
  },
  {
    header: "2. Who can participate in the tournament?",
  ...
  {
    header: "7. What happens if I violate the rules?",
  ...
  {
    header: "8. Can I withdraw from the tournament?",
    body: "A participant may withdraw from participation in the Tournament at any time.",
  },
  {
    header: "9. What are the prizes for the tournament?",
  ...
  {
    header: "10. Can the rules of the tournament change?",
